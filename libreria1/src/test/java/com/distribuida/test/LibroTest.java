...
public class LibroTest {
    ...
    public void setup() {
        ...
        libro = new Libro(1, "Java Básico", "McGraw-Hill", 350, "3ra", "Español", fechaPublicacion,
                "Tapa", "Introducción al lenguaje", "1234567890123", 10, "portada.jpg",
    ...
    public void testLibroConstructorAndGetters() {
        assertAll("Validar datos Libro, Constructor y Getters",
                ...
                () -> assertEquals("Introducción al lenguaje", libro.getDescripcion()),
                () -> assertEquals("Tapa", libro.getTipoPasta()),
                () -> assertEquals("1234567890123", libro.getiSBN()),
                () -> assertEquals(10, libro.getNumEjemplares()),
                () -> assertEquals("portada.jpg", libro.getProtada()),
                () -> assertEquals("Presentación física", libro.getPresntacion()),
    ...
    public void testLibroSetters() {
        ...
        libro.setProtada("nueva_portada.jpg");
        libro.setPresntacion("Presentación digital");
        ...
        assertAll("Validar datos Libro, Setters",
                ...
                () -> assertEquals("nueva_portada.jpg", libro.getProtada()),
                () -> assertEquals("Presentación digital", libro.getPresntacion()),
    ...
    public void testLibroToString() {
        ...
        assertAll("Validar Datos Libro - ToString",
                ...
                () -> assertTrue(str.contains("Introducción al lenguaje")),
                () -> assertTrue(str.contains("Tapa")),
