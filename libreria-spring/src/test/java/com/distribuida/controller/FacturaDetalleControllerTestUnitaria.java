...
public class FacturaDetalleControllerTestUnitaria {
    ...
    public void testFindOneNoExistente(){
        ...
        ResponseEntity<FacturaDetalle> repuesta = facturaDetalleController.FindOne(2);
        assertEquals(404,repuesta.getStatusCodeValue());
    }
    ...
    public void testFindByFacturaId() {
        ...
        ResponseEntity<List<FacturaDetalle>> respuesta = facturaDetalleController.finByFacturaId(1);
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals(1, respuesta.getBody().size());
    }
