...
public class CategoriaControllerTestUnitaria {
    private static final Logger log = LoggerFactory.getLogger(CategoriaControllerTestUnitaria.class);
    @InjectMocks
    ...
    public void setUp(){
        ...
        categoria.setDescripcion("Libros de tecnologia");
    ...
    public void testFindOneExistente(){
        ...
        assertEquals("Libros de tecnologia", respuesta.getBody().getDescripcion());
