...
public class CategoriaServicioTestUnitaria {
    ...
    @InjectMocks
    private CategoriaServicelmpl categoriaService;
    ...
    public void setUp(){
        ...
        categoria.setDescripcion("Literal XD");
    ...
    public void  testFindOneExistente(){
        ...
        assertEquals("Accion",resultado.getCategoria());
    ...
    public void testUpdateExistente(){
        ...
        categoriaActualizada.setCategoria("Poesia");
        categoriaActualizada.setDescripcion("Obra");
        ...
        assertNotNull(resultado);
        assertEquals("Poesia", resultado.getCategoria());
